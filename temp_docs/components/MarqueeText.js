...
const MarqueeText = ({ children, className, loopDelay, duration, startAnimation, isOverflowing, contentRef, onClick }) => {
    ...
    if (!isOverflowing) {
        return (React.createElement("div", { className: `truncate ${wrapperClasses}`, onClick: onClick },
            React.createElement("span", { ref: contentRef, className: "inline-block" }, children)));
    }
    ...
    return (React.createElement("div", { className: `marquee-wrapper ${wrapperClasses}`, onClick: onClick },
        React.createElement("div", { ref: marqueeDivRef, className: "animate-marquee inline-flex", style: marqueeStyle },
            React.createElement("span", { className: "pr-4 flex-shrink-0", ref: contentRef }, children),
            React.createElement("span", { className: "pr-4 flex-shrink-0", "aria-hidden": "true" }, children))));
};
